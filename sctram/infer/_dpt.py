...
class DPTInference(TrajectoryInferenceBase):    
    ...
    Additional Methods:
        _calculate: Performs the DPT calculation to identify cell trajectories.
        _get_result: Retrieves and returns the DPT result/results. Please note that "None" and "anndata"
